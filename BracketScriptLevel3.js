pc.script.create('BracketScriptLevel3', function (app) {
    // Creates a new BracketScriptLevel3 instance
    var BracketScriptLevel3 = function (entity) {
        this.entity = entity;
        this.entity.level = 2;
    };

    BracketScriptLevel3.prototype = {
